...
CURRENT_SCHEMA = {
    ...
    "grid_current1":            ("gridCur1",           "211/result",       "A",     "Electrical (211)"),
    "grid_current2":            ("gridCur2",           "211/result",       "A",     "Electrical (211)"),
    "grid_frequency":           ("gridFreq",           "211/result",       "Hz",    "Electrical (211)"),
    "grid_set_frequency":       ("gridSetFreq",        "211/result",       "Hz",    "Electrical (211)"),
    "grid_line_voltage":        ("gridLineVol÷10",     "211/result",       "V",     "Electrical (211)"),
    "generator_voltage":        ("oilVol",             "211/result",       "V",     "Electrical (211)"),
...
def _terminal_output(live_current, live_totals, filter_group):
    ...
    print()
    print("  Relay encoding: 1=CLOSED (connected), 0=OPEN (disconnected)  — all relays")
