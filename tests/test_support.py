...
class TestRedactEmail:
    def test_partial(self):
        assert _redact_email("david.hona@gmail.com", "partial") == "d***@g***.com"

    def test_full(self):
        assert _redact_email("david.hona@gmail.com", "full") == "[REDACTED]"
...
class TestRedactSerial:
    def test_partial(self):
        assert _redact_serial("10060006A02F24170091", "partial") == "1006***0091"

    def test_full(self):
        assert _redact_serial("10060006A02F24170091", "full") == "[REDACTED]"
...
class TestRedactSnapshot:
    ...
    def test_full_redacts_everything(self):
        data = {
            "identity": {"serial": "10060006A02F24170091", "email": "a@b.com"},
    ...
    def test_does_not_mutate_original(self):
        data = {"identity": {"serial": "10060006A02F24170091"}}
        redact_snapshot(data, "partial")
        assert data["identity"]["serial"] == "10060006A02F24170091"
