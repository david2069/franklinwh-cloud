...
* **Strict Negative Testing Rules (AP-13):** **DO NOT** execute negative authentication testing (simulated bad passwords mapping to real emails) against the live API. All negative Token logic features must be performed strictly using **Dummy Emails** to prevent physical client lockout.
